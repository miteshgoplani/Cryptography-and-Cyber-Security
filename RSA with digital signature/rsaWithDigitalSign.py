...
choice = int(input("Enter 0 for encryption and decryption and 1 for digital signature"))
...
if choice == 0:
    ...
    p = int(input("Enter shared secret number"))
    sign = (p**d)%n
    print("Digital signature is ",sign)
    print()
    print("=========Verification=======")
    c = int(input("Enter Digital Signature"))
    verify = (c**e)%n
    if verify == p:
        print("User Verified")
    else:
